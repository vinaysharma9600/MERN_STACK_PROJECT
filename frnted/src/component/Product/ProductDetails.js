...
import { NEW_REVIEW_RESET } from '../../constants/productconsant';
...
const ProductDetails = ({ match }) => {
  ...
  return (
   <>
        {loading ? <Loader/> :(
             <>
             <MetaData title = " Stock Clear--PRODUCTS"/>
             ...
             >
                <DialogTitle className='submitreviewtitle'>Submit Review</DialogTitle>
